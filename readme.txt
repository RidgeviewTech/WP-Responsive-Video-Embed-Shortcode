...
Add any of the following attributes to the shortcode to control position and size. You can also ONLY use src and the video will be placed at 100% and respond within the containing page element.
    ...
    src = only use the YouTube id
    max-width = in px
    float = rest of page wraps up around video, include padding on the other side so the text doesn't run up against the edge of the video. Values can be left or right.
